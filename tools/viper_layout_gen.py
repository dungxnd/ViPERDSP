...
ViPER4Android:
    ...
    python ViPERDSP/tools/viper_layout_gen.py \
        ...
        --include-dir ViPERDSP/include \
        --lang        kotlin \
        --package     com.llsl.viper4android.audio \
        --output      ./app/src/main/java/com/llsl/viper4android/audio/ViperParamsLayout.kt \
        --generator-path "ViPERDSP/tools/viper_layout_gen.py"
...
class LangConfig:
    ...
    array_suffix: str  # `_COUNT` / `_LEN` — local convention per app
...
def make_swift_config() -> LangConfig:
    raise NotImplementedError(
        "Swift codegen not yet implemented; use name_case=keep_verbatim "
        "(Swift constants keep camelCase)"
    )


def make_dart_config() -> LangConfig:
    raise NotImplementedError(
        "Dart codegen not yet implemented; use name_case=keep_verbatim "
        "(Dart constants keep camelCase)"
    )
...
def main():
    ...
    if args.lang == "kotlin":
        ...
        raise SystemExit("Swift codegen not yet implemented")
    elif args.lang == "dart":
        raise SystemExit("Dart codegen not yet implemented")
    else:
